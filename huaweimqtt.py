                ...
                try:
                    ...
                    if register == 'input_power':
                          ...
                          #  print(f"Taegliche Ertragsenergie: {result[0]}")
                            ...
                            mqtttopic = f"openWB/set/bat/{bat_number}/get/soc"
                            message = result[0]

                    elif register == "storage_charge_discharge_power":
                            mqtttopic = f"openWB/set/bat/{bat_number}/get/power"
                            message = result[0]

                    elif register == "storage_current_day_charge_capacity":
                            mqtttopic = f"openWB/set/bat/{bat_number}/get/imported"
                            message = result[0] * 1000

                    elif register == "storage_current_day_discharge_capacity":
                            mqtttopic = f"openWB/set/bat/{bat_number}/get/exported"
                            message = result[0] * 1000

                    elif register == "power_meter_active_power":
                            mqtttopic = f"openWB/set/counter/{counter_number}/get/power"
                            message = result[0]  * -1

                    elif register == "grid_frequency":
                            mqtttopic = f"openWB/set/counter/{counter_number}/get/frequency"
                            message = result[0]
                        ...
                        # Append numerical grid currents to the array
                            ...
                            mqtttopic = f"openWB/set/counter/{counter_number}/get/currents"
                            ...
                            mqtttopic = f"openWB/set/counter/{counter_number}/get/voltages"
                            ...
                            mqtttopic = f"openWB/set/counter/{counter_number}/get/powers"
...
topic_mapping = {
    ...
    'grid_accumulated_energy': f"openWB/set/counter/{counter_number}/get/imported",
    'power_meter_active_power': f"openWB/set/counter/{counter_number}/get/power",
    'grid_frequency': f"openWB/set/counter/{counter_number}/get/frequency",
    'grid_exported_energy': f"openWB/set/counter/{counter_number}/get/exported",
    'storage_charge_discharge_power': f"openWB/set/bat/{bat_number}/get/power",
    'storage_current_day_charge_capacity': f"openWB/set/bat/{bat_number}/get/imported",
    'storage_current_day_discharge_capacity': f"openWB/set/bat/{bat_number}/get/exported",
    'storage_state_of_capacity': f"openWB/set/bat/{bat_number}/get/soc",
}
